...
namespace Andy.Mes.Persistence
{
    public static class DbModelFactory
    {
        ...
        {
            var assemblies = new Assembly[] { Assembly.Load($"{SystemConfig.ProjectNamePre}.Entity") };
            List<Type> allTypes = new List<Type>();
            Array.ForEach(assemblies, aAssembly =>
            {
        ...
        private static IList<IRepositoryDbContext> _observers { get; } = new List<IRepositoryDbContext>();
